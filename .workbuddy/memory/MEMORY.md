...
## VVD Tier Analyzer (新应用, 2026-05-21)
- **脚本**: `vvd_tier_analyzer.py`
- **输出**: `VVD_Tier_Analyzer.html` (交互式，输入 VVD → 展示完整 Tier 分析)
...
- **SEA 区域**: TW=Taiwan, VN=Vietnam, TH=Thailand, JP=Japan, KR=Korea, MY=Malaysia
- **不推 GitHub** (用户明确要求)
